...
class TestMetaDataValidation(unittest.TestCase):
    ...
    def test_project_validation(self):
        ...
        self.sub.project.publications = [datamodel.components.Publication(articleTitle="Test Article Title", authors="everyone", pubmedId="haha", doi="000", publicationStatus="")]
